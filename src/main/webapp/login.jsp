...
<BODY>
<FORM id=form1 name=form1 onsubmit="javascript:return WebForm_OnSubmit();" method=post target="_parent" action="user_login.action">
                            ...
                            <TR>
                                ...
                                <TD>
                                    <TABLE cellSpacing=0 cellPadding=2 border=0>
                                        ...
                                        <TR>
                                            <TD style="HEIGHT: 18px" colspan="3"><s:actionerror/></TD>
                                        <TR>
