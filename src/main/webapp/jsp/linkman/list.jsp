                    ...
                    <TR>
                        <TD height=25>
                            <TABLE cellSpacing=0 cellPadding=2 border=0>
                                ...
                                <TR>
                                    <TD>联系人名称：</TD>
                                    <TD><s:textfield cssClass="textbox" name="lkm_name" cssStyle="WIDTH: 80px"/></TD>
                                    <td>联系人性别:</td>
                                    <TD>
                                        <s:select list="#{ '1':'男','2':'女' }" name="lkm_gender" headerKey="" headerValue="-请选择-"/>
                                    </TD>
                                ...
                                <s:if test="list!=null">
                                    <s:iterator value="list">
                                        <TR
                                            ...
                                            <TD><s:property value="lkm_hobby"/></TD>
