										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>联系人名称：</TD>
													<TD>
													<s:textfield name="lkm_name" id="lkm_name"
														cssClass="textbox" cssStyle="WIDTH: 80px" ></s:textfield>
													</TD>
													<TD>性别：</TD>
													<TD>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												到
												<!-- 表示当前页 -->
												<input type="text" size="3" id="page" name="currPage" value="<s:property value="currPage"/>"/>
												页
