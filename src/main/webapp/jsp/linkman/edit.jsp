					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							<tr>
								<td>所属客户：</td>
								<td colspan="3">
									<s:select list="list" name="customer.cust_id" listKey="cust_id" listValue="cust_name" headerValue="-请选择-" headerKey=""/>
								</td>
							</tr>
							<TR>
								<td>联系人名称：</td>
							...
							<TR>
								...
								<td>联系人备注 ：</td>
								<td>
									<s:textarea rows="3" cols="10" cssClass="textbox" cssStyle="width:180px" name="lkm_memo"/>
								</td>
							</TR>
							<TR>
								<td>联系人爱好：</td>
								<td colspan="3">
									<s:checkboxlist list="{'高尔夫','游泳','潜水','骑马'}" name="lkm_hobby" value="%{lkm_hobby.split(', ')}"/>
								</td>
							</TR>
							<tr>
								<td rowspan=2>
